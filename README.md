...
装備画像は `warframe-items` の README が案内している **`https://cdn.warframestat.us/img/`**
から取得します。GitHub/jsDelivr の `data/img` は容量制限などで直接配信できないことがあるためです。
